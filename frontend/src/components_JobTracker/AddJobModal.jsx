...
const AddJobModal = ({
  ...
  const [formData, setFormData] = useState({
    ...
    column: newJob.status || "Applied",
    salary: newJob.salary || "",
    jobType: "",
    location: newJob.location || "",
    url: "",
    appliedOn: newJob.dateApplied || "",
    deadline: newJob.interviewDate || "",
    description: "",
  });
  ...
  const handleSubmit = () => {
    const jobToSave = {
      ...
      dateApplied: formData.appliedOn,
      interviewDate: formData.deadline,
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="bg-black hover:bg-gray-800 text-white px-6 py-2 rounded-md font-medium transition-colors"
            >
              Save & Close
            </button>
          </div>
